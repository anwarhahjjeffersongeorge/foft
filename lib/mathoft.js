  ...
  (0, _createClass2.default)(MathOfT, [{
    ...
    */
    ...
    value: function oft(t) {
      ...
      var tthis = (0, _typeof2.default)(this.tthis) === 'object' ? this.tthis : MathOfT.TTHIS_TEMPLATE(t, this);
      var result = [];
    ...
    */
    ...
    value: function TTHIS_TEMPLATE(t, mathoft) {
      ...
      var populateFunc = mathoft instanceof MathOfT && MathOfT.ISNUMBER(t) ? function (key) {
        return o[key] = mathoft[key](t);
      } : function () {
        return null;
      };
      var populateMemb = mathoft instanceof MathOfT ? function (key) {
        return o[key] = mathoft[key];
      } : function () {
        return null;
      };
...
(0, _defineProperty2.default)(MathOfT, "ISCALCULABLE", function () {
  return MathOfT.ISNUMBER(arguments[0]) && (0, _isFinite.default)(arguments[0]);
});
...
(0, _defineProperty2.default)(MathOfT, "FUNCKEYS", ['normalizeT', 'antinormalizeT', 'i']);
(0, _defineProperty2.default)(MathOfT, "MEMBERKEYS", ['range', 'drange', 't0', 'segmentDivisor']);
