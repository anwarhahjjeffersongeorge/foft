...
Object.defineProperties(MathOfT, {
  ...
  ISOP: {
    get: function get() {
      return function (codeToParse) {
        return codeToParse in MathOfT.OPDICT;
      };
    },
    set: function set() {
      return null;
  ...
  OPPARSE: {
    get: function get() {
      return function (codeToParse) {
        return MathOfT.ISOP(codeToParse) ? codeToParse : MathFunction.OfT.OPDICT[null];
      };
    },
    set: function set() {
      return null;
  ...
  OPS: {
    value: Object.defineProperties({}, (_Object$definePropert = {}, _defineProperty(_Object$definePropert, null, {
      get: function get() {
        function res() {
          return arguments;
        }
      ...
      get: function get() {
        var res = function res(a, b) {
          return MathOfT.ARENUMBERS(a, b) ? a + b : NaN;
        };
      ...
      get: function get() {
        var res = function res(a, b) {
          return MathOfT.ARENUMBERS(a, b) ? Math.pow(a, b) : NaN;
        };
